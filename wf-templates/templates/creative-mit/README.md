...
Sitio generado con **Web Factory (AUVRO)**. Plantilla: `creative-mit` (Bootstrap 5, estática, sin build).

Basada en **Creative - Start Bootstrap v7.0.7** (https://startbootstrap.com/theme/creative),
...
marcados (`EMPRESA`, `DESCRIPCION`, `SLOGAN`, `LOGO`, `WHATSAPP`). Si el número
de WhatsApp queda vacío, los botones de WhatsApp se ocultan solos.
